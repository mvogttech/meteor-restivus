Package.describe({
	name: "mvogt22:restivus",
	summary:
		"Create authenticated REST APIs in Meteor 2.3+ via HTTP/HTTPS. Setup CRUD endpoints for Collections.",
	version: "0.8.13",
	git: "https://github.com/mvogttech/meteor-restivus.git"
});
